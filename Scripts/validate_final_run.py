...
and the 104 in-engine automation tests (behavioral, ENGINE-UNVERIFIED until run).
"""
import os
import re
import sys
...
check("Automation tests == 104 (99 + 3 FCR regressions + 1 DP-3 resonance + 1 DP-4 skill loadout)", count == 104, f"count={count} — update this gate + all active docs together")
