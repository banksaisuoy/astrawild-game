...
pull → build → 108/108 tests → PIE boot+golden path incl. both endings → save round-trip →
...
> UE5-VERIFIED — AG-2..AG-5 (build, 108/108 tests, PIE golden path, package) remain the
