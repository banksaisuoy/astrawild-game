...
set EDITOR_EXE=%UE_ROOT%\Engine\Binaries\Win64\UnrealEditor-Cmd.exe
...
"%EDITOR_EXE%" "%PROJECT%" -ExecutePythonScript="%SCRIPT_PATH%" -unattended -nopause -nullrhi -nosplash -log -stdout -FullStdOutLogOutput -ABSLOG="%LOG%" -NoLiveCoding
set RC=%ERRORLEVEL%
echo.
