...
$required = @(
    ...
    "Content/Astrawild/Data/Source/DT_FishDex.csv",
    "Content/Astrawild/Data/Source/DT_Dyes.csv",
    "Content/Astrawild/Data/Source/DT_WorldKaijuBosses.csv",
    "Content/Astrawild/Data/Source/DT_Vehicles.csv",
    "Content/Astrawild/Data/Source/DT_VehicleParts.csv",
    ...
    "Scripts\validate_vehicle_contracts.py",
