...
echo === ASTRAWILD Phase 4b: rebuild after touching data headers ===
"%UE_ROOT%\Engine\Build\BatchFiles\Build.bat" ASTRAWILDEditor Win64 Development -Project="%PROJECT%" -WaitMutex -NoHotReload
set RC=%ERRORLEVEL%
